        ...
        <div className="hotel">
            ...
            <div className="hotelContainer">
                <div className="hotelWrapper">
                    <button className="hotelButton booknowButton">Reserve or Book Now!</button>
                    ...
                    <span className="hotelPriceHightlight">Book a stay over $114 at this property and get a free airport taxi</span>
